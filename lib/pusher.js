...
JPusher.prototype.push = function(pushParam, content, callback) {
    ...
    queryStringArray.apns_production = pushParam.apnsProduction;
    ...
    if(queryStringArray.msg_type === param.MessageType.MT_NOTIFICATION) {
        queryStringArray.msg_content = {
            ...
            "n_content"     : content,
            "n_extras"      : { "ios": pushParam.iOSExtra }
        };
        ...
        if(!queryStringArray.msg_content.n_extras.ios.length) {
            delete queryStringArray.msg_content.n_extras;
        }
